...
const Riot = () => {
  ...
  const [switchgame, setSwitch]= useState("league");
  ...
  return (
    <div className="games text-light text-center">
      ...
      <div className="switch d-flex">
        <button className="btn btn-info text-white" onClick={() => setSwitch("league")}>League of Legends</button>
        <button className="btn btn-info text-white" onClick={() => setSwitch("valorant")}>Valorant</button>
