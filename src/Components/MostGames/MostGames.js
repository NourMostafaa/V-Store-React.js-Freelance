...
const MostContent = () => {
    ...
    useEffect(() => {
        const fetchGames = async () => {
            const querySnapshot = await getDocs(collection(db, "most"));
    ...
    return (
        <div className="games text-light text-center" id="most">
            <h1>Most Popular</h1>
        ...
        pay_content.style.display = 'none';
            ...
            <div className="games-content">
                {games.length === 0 ? (
                    ...
                    games.map((game) => (
                        <div className="game-card most-card" key={game.id}>
                            ...
                            <div className="btns">
                                <button type="button" className="btn btn-info text-light now" onClick={(e) => {
                                    let pay_content = document.querySelector('.pay-content')
